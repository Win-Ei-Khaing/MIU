...
class MainActivity : AppCompatActivity() {
 ...
 /*  Handles the onClick for the "Open Website" button.  Gets the URI
    ...
    // Refer more info : https://developers.google.com/maps/documentation/urls/android-intents#kotlin_2
    ...
    fun shareText(view: View) {
        ...
        // Build the share intent with the mime type text/plain and launch
        // a chooser for the user to pick an app.
        ShareCompat.IntentBuilder
            .from(this)
            .setType("text/plain")
            .setChooserTitle("Share this text with: ")
            .setText(txt) // Input Text
