...
public class Test extends TestCase {
	...
	private String setupDirectory = System.getProperty("user.dir"); //"C:\\testCode";
	private String targetFile = "seek.txt";
	@Override
	public void setUp() {
		/*File f = new File("testFolder/testFiles/");
		...
		System.out.println(f.mkdirs());*/
		insert = new File("seek.txt");
		System.out.println("writing to " + insert.getAbsolutePath());
		try {
			PrintWriter pw = new PrintWriter(insert);
