...
INSERT into USER (user_id, username, password, active) values (1, 'user', '$2a$12$e1IqiuwavINog6ErXnMRI.cBqCcYsx6hf.RhRVgA8FGPP5yZkVl/a', 1);
INSERT into USER (user_id, username, password, active) values (2, 'admin', '$2a$12$51rW3YPwI1nkdFNP6zHiF.ZpM2JSvQ0WtcjOEvfOU1x3.KPvsQFey', 1);
