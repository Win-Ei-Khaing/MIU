...
public class AnnotationInfo {
	public static void main(String[] args) {
		...
		System.out.println("\n----------------------");
		System.out.println("\nAnnotation on MoreBadCode\n--------------------------");
		Class<StillMoreBadCode> moreStillBadCodeClass = StillMoreBadCode.class;
		if (moreStillBadCodeClass.isAnnotationPresent(BugReport.class)) {			 
			BugReport annotation = (BugReport)moreStillBadCodeClass.getAnnotation(BugReport.class);			 
			System.out.printf("%nAssigned To : %s ", annotation.assignedTo());
			System.out.printf("%nSeverity : %d ", annotation.severity());
		}
	}
