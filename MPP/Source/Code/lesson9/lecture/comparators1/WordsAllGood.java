...
public class WordsAllGood {
	...
	public static void goodSort1() {
		...
		List<String> sorted1 = words.stream().sorted((x,y)->y.length()-x.length()).collect(Collectors.toList());
		List<String> sorted2 = words.stream().sorted(Comparator.comparing(f).reversed()).collect(Collectors.toList());
