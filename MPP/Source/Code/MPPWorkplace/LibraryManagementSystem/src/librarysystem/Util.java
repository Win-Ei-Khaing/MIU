...
public class Util {
	...
	/*public static void makeTinyFont(String label, Font f) {
		Font font = new Font(label.getFont().getName(), 
				label.().getStyle(), (label.getFont().getSize()-3));
		label.setFont(font);
    }*/
	
	public static Font makeTinyFont(Font f) {
        return new Font(f.getName(), f.getStyle(), (f.getSize()-2));
    }
