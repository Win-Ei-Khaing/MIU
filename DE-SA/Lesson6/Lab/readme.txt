...
I've finished all parts of Spring Integration assignment with my own best work. I cloned ShippingService project for NextDayShippingService and InternationalShippingService. For part (a) and (b), I attached all the project files, running on the following ports.

EnterpriseServiceBus - 8080
OrderService - 8083
WarehouseService - 8081
ShippingService - 8082
NextDayShippingService - 8084
InternationalShippingService - 8085
